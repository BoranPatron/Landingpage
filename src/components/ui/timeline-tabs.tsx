...
export const TimelineTabs: React.FC<TimelineTabsProps> = ({
  ...
  return (
    <div className="flex gap-3 md:gap-4 mb-8 justify-center md:justify-start">
      <button
        onClick={() => onRoleChange("bauträger")}
        className={`px-5 py-3.5 md:px-6 md:py-3 rounded-lg font-semibold text-sm md:text-base transition-all duration-300 min-h-[44px] md:min-h-0 ${
