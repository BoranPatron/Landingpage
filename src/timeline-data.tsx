...
export const bautraegerTimelineData: TimelineEntry[] = [
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-base md:text-lg font-normal mb-10">
          Finden Sie qualifizierte Partner in Ihrer Nähe. Geo-basierte Suche bringt Sie mit den besten 
          Dienstleistern zusammen - geprüft, verifiziert und bewertet.
        </p>
        <p className="text-neutral-800 dark:text-neutral-200 text-base md:text-lg font-normal mb-10">
    ...
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-base md:text-lg font-normal mb-6">
          Alles im Blick: Dokumente, Aufgaben, Finanzen. Verwalten Sie Ihre gesamte Projektkommunikation 
          an einem Ort und behalten Sie den Überblick über jeden Schritt.
        </p>
        <div className="mb-8">
          <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base mb-3">
            Projektmanagement mit Bauphasen-Tracking
          </div>
          <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base mb-3">
...
export const dienstleisterTimelineData: TimelineEntry[] = [
  {
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-base md:text-lg font-normal mb-10">
          Zeigen Sie Ihre Expertise und gewinnen Sie Aufträge. Präsentieren Sie Ihre Firma, 
          Referenzen und Qualifikationen professionell - direkt auf der Plattform.
        </p>
        <p className="text-neutral-800 dark:text-neutral-200 text-base md:text-lg font-normal mb-10">
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="text-neutral-800 dark:text-neutral-200 text-base md:text-lg font-normal mb-6">
          Verwalten Sie Personal und Material optimal. Planen Sie Ressourcen, verfolgen Sie Projekte 
          und kollaborieren Sie effizient mit Bauträgern - alles aus einer Hand.
        </p>
        <div className="mb-8">
          <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base mb-3">
            ✅ Ressourcenmanagement & Auslastung
          </div>
          <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base mb-3">
            ✅ Rechnungsverwaltung & Zahlungstracking
          </div>
          <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base mb-3">
            ✅ Projektkollaboration mit Bauträgern
          </div>
          <div className="flex gap-3 items-center text-neutral-700 dark:text-neutral-300 text-sm md:text-base mb-3">
